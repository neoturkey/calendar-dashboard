...
function build_reminder(reminder_dict) {
    ...
    try {
        ...
        console.log(
            'build_reminder failed: unrecognized reminder dictionary format'
        );
        return null;
    }
}

export function create_reminder(reminder, access_token, callback) {
    /*
...
export function get_reminder(reminder_id, access_token, callback) {
    /*
...
export function delete_reminder(reminder_id, access_token, callback) {
    /*
...
export function list_reminders(num_reminders, access_token, callback) {
    /*
